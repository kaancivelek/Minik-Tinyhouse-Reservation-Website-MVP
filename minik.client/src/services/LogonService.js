...
export const getUserByEmail = (email) => {request(`/user/by-email`, 'GET', { email })};
export const deleteUser = (email) => request(`/Logon/${email}`, 'DELETE');
export const validateUser = (email, password,twoFactorCode,twoFactorRecoveryCode) => request(`/Login/login`, 'POST', { email, password, twoFactorCode,twoFactorRecoveryCode });
